...
<template>
    ...
    <AdminLayout>
        <template #header>
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">New Branch</h2>
        </template>
        ...
        <div class="mx-auto max-w-2xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
            <Card>
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <Input id="name" v-model="form.name" label="Branch Name" required :error="form.errors.name" class="sm:col-span-1" />
            ...
            <div class="flex justify-end">
                <Button :disabled="form.processing" @click="submit"><Save class="h-4 w-4" />Save Branch</Button>
            </div>
        </div>
    </AdminLayout>
</template>
