...
<template>
    <header class="sticky top-0 z-20 flex h-16 shrink-0 items-center gap-4 border-b border-gray-200 bg-white px-4 dark:border-gray-700 dark:bg-gray-800 sm:px-6 lg:px-8">
        ...
        <h1 class="truncate text-base font-semibold text-gray-900 dark:text-gray-100 sm:text-lg">Admin</h1>
        ...
        <div class="ml-auto flex items-center gap-1">
            ...
            <Dropdown align="right" width="48">
                <template #trigger>
                    ...
                    >
                        <span class="hidden text-sm font-medium text-gray-700 dark:text-gray-200 sm:block">{{ page.props.auth.user.name }}</span>
