...
const icons = {
    ...
    bug: 'M12 12.75a3 3 0 100-6 3 3 0 000 6zm-9-3a9 9 0 1118 0 9 9 0 01-18 0zm3.75-.75h1.5m9-1.5h1.5m-13.5 4.5h1.5m9 0h1.5M12 6V4.5m0 15V18',
};
...
const navItems = computed(() => [
    ...
    ...(page.props.auth.isDev ? [{ name: 'Dev · Errors', route: 'admin.dev.errors.index', icon: 'bug' }] : []),
]);
</script>
